...
#
# ak = "AKLTMTg3MTJhYTE3ZDZjNGExMDk4MDM1ZjhhYjBhZTNlYTA"
# sk = "T1dNME5qTmpOemszTXpVMU5ESXlNMkpqTlRNMVlqSTBaVGt4WWpoaVpESQ=="
# region = "cn-beijing"
# volcengine_ml_platform.init(ak=ak, sk=sk, region=region)
